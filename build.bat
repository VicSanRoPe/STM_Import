...
lua54.exe extraer_gpx.lua | tee salida2.txt


osmfilter "MontevideoConParadas.osm" --drop-author --keep= --keep-ways="highway=" -o="MontevideoReducido.osm"


lua54.exe recorrer_camino.lua | tee salida3.txt


lua54.exe partir_ways.lua | tee salida4.txt


osmfilter "MontevideoPartido.osm" --drop-author --keep= --keep-ways="highway=" -o="MontevideoReducido.osm"


lua54.exe recorrer_camino.lua | tee salida5.txt


lua54.exe agregar_buses.lua | tee salida6.txt
